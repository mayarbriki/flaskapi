...
_, _, y_train_potential, y_test_potential = train_test_split(X, y_potential, test_size=0.2, random_state=42)
...
print("\n✅ Models saved: value_model.pkl, potential_model.pkl, scaler.pkl, label_encoders.pkl")
